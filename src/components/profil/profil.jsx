...
import safe from '../../images/certification/safe.png';
    ...
    >
      ...
      <Box alignSelf="center" px="29" py="16">
        ...
        <Flex direction={isNotSmallerScreen ? 'row' : 'column'} mt={8}>
          <Flex rounded="xl" ml={isNotSmallerScreen ? 4 : 0} bg="blue.600" direction="column" mt={4} h="21vh" w="21vh" justify="flex-end" _hover={{ bg: 'gray.400' }}>
            <Image src={safe} ml="auto" mr="auto" boxSize="100px" objectFit="cover" alt="safe" />
